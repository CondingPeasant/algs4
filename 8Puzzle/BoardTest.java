...
public class BoardTest {
    private int[][] blockGoal_2D = {{1, 2},
                                    {3, 0}};
    private int[][] blockGoal_3D = {{1, 2, 3},
                                    {4, 5, 6},
                                    {7, 8, 0}};

    private int[][] block1 = {{8, 1, 3},
                              {4, 0, 2},
                              {7, 6, 5}};
    private int[][] block1_twin = {{8, 1, 3},
                                   {4, 0, 6},
                                   {7, 2, 5}};
    private int[][] block1_neighbor1 = {{8, 0, 3},
                                        {4, 1, 2},
                                        {7, 6, 5}};
    private int[][] block1_neighbor2 = {{8, 1, 3},
                                        {0, 4, 2},
                                        {7, 6, 5}};
    private int[][] block1_neighbor3 = {{8, 1, 3},
                                        {4, 6, 2},
                                        {7, 0, 5}};
    private int[][] block1_neighbor4 = {{8, 1, 3},
                                        {4, 2, 0},
                                        {7, 6, 5}};

    private int[][] block2 = {{8, 1, 3},
                              {4, 5, 2},
                              {7, 6, 0}};
    private int[][] block2_twin = {{8, 1, 7},
                                   {4, 5, 2},
                                   {3, 6, 0}};
    private int[][] block2_neighbor1 = {{8, 1, 3},
                                        {4, 5, 0},
                                        {7, 6, 2}};
    private int[][] block2_neighbor2 = {{8, 1, 3},
                                        {4, 5, 2},
                                        {7, 0, 6}};

    private int[][] block3 = {{8, 0, 3},
                              {4, 5, 2},
                              {7, 6, 1}};
    private int[][] block3_neighbor1 = {{0, 8, 3},
                                        {4, 5, 2},
                                        {7, 6, 1}};
    private int[][] block3_neighbor2 = {{8, 5, 3},
                                        {4, 0, 2},
                                        {7, 6, 1}};
    private int[][] block3_neighbor3 = {{8, 3, 0},
                                        {4, 5, 2},
                                        {7, 6, 1}};
    @Test
